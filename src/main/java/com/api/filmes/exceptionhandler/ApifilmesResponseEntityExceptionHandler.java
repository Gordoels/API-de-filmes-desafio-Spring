...
public class ApifilmesResponseEntityExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessExcpetion(EmptyResultDataAccessException ex, WebRequest request) {
		...
		String messageForUser = messageSource.getMessage("resource.dont-exist", null, LocaleContextHolder.getLocale());
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request){
		...
		String messageForUser = messageSource.getMessage("resource.operation-not-allowed", null, LocaleContextHolder.getLocale());
		String messageForDeveloper = ExceptionUtils.getRootCauseMessage(ex);
